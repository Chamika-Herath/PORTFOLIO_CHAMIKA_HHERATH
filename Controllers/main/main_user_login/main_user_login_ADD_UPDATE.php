...
class main_user_login_ADD_UPDATE
{
    ...
    public function get_data($get_user_name, $get_password, $get_last_login, $get_name_show, $get_cook_key, $get_ref_key,
                            $get_ac_type,  $get_company_id, $get_main_user_account_access_level_list_id, $get_image_url,
                            $get_google_id, $get_google_authentication_secret, $get_microsoft_id, $get_first_name, $get_last_name,
                            $get_dis, $get_phone_number, $get_wrong_login_count){
            ...
            $this->sql_update_query = 
                ...
                wrong_login_count='". $this->wrong_login_count."'";
                }
    ...
    public function is_google_authentication_enable(){
    ...
    public function process_new_record(){
        ...
        $get_sql_query = "INSERT INTO main_user_login 
                                (user_name, 
                                password, 
    ...
    public function process_update(){
        $data_base_obj = new DataBase();
        $get_sql_query = "UPDATE main_user_login SET ast='" . $this->ast . "', sdt='" . $this->sdt . "' " . $this->sql_update_query . " WHERE id='" . $this->id . "' AND main_user_login_id='" . $this->main_user_login_id . "'";
        $data_base_obj->get_result($get_sql_query);
        $this->error_msg = $data_base_obj->get_error();
        return $data_base_obj->get_error_state_boolean();
    }
